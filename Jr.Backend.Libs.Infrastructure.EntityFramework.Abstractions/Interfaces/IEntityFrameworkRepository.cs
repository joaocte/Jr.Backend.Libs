...
namespace Jr.Backend.Libs.Infrastructure.EntityFramework.Abstractions.Interfaces
{
    public interface IEntityFrameworkRepository<T> : IRepository<T>, IQueryRepository<T>
    where T : class
    {
        /// <summary>
